...
function WhyJoinUs() {
  ...
  return (
    <div className='my-20'>
     ...
     <h1 className={` pl-4 font-bold text-3xl capitalize text-transparent bg-clip-text ${theme === "dark" ? "bg-gray-300": `bg-gradient-to-l from-rose-500 to-orange-500 `} `}> Reasons to join: </h1>
    <div className=" grid grid-cols-1 px-2 my-5 text-lg md:grid-cols-4 w-[80%] md:w-full lg:w-[80%] gap-5 mx-auto">
       
        <div className={`bg-gradient-to-bl ${theme === "light" && "from-green-500 to-lime-500 border-gray-200"} bg-gray-800  border border-gray-400  h-28  p-2 rounded-lg relative `}>
        ...
        <div className={`bg-gradient-to-br ${theme === "light" && "from-orange-500 to-slate-200 border-gray-200"}  border bg-gray-800 border-gray-400 h-28 p-2 relative rounded-lg  `}>
        ...
        <div className={`bg-gradient-to-br ${theme === "light" && "from-rose-500 to-gray-200 border-gray-200"} border bg-gray-800 border-gray-400 h-28 p-2 rounded-lg relative `}>
        ...
        <div className={`bg-gradient-to-br ${theme === "light" && "from-green-500 to-gray-200 border-gray-200"} border bg-gray-800 border-gray-400 h-28 p-2 rounded-lg relative  `}>
